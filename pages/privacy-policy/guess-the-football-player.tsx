...
export default function GuessTheFootballPlayer() {
  return (
    <>
      <Head>
        <title> Privacy Policy - Guess The Football Player</title>
      </Head>
      <div className="privacy-policy">
        <h1>Privacy Policy</h1>
        <p>
          Edin Kahvedžić built the Guess The Football Player app as a Free app.
          This SERVICE is provided by Edin Kahvedžić at no cost and is intended
          for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Guess The Football
          Player unless otherwise defined in this Privacy Policy.
        </p>
        ...
        <p>
          ...
          not hesitate to contact me at mail@edinkahvedzic.com.
        </p>
      </div>
    </>
  );
